...
public class SnowboyVad {
  ...
  public boolean Reset() { return snowboyJNI.SnowboyVad_Reset(swigCPtr, this); }
  ...
  public int RunVad(float[] data, int array_length, boolean is_end) {
    return snowboyJNI.SnowboyVad_RunVad__SWIG_2(swigCPtr, this, data,
                                                array_length, is_end);
  }

  public int RunVad(float[] data, int array_length) {
    return snowboyJNI.SnowboyVad_RunVad__SWIG_3(swigCPtr, this, data,
                                                array_length);
  }

  public int RunVad(short[] data, int array_length, boolean is_end) {
    return snowboyJNI.SnowboyVad_RunVad__SWIG_4(swigCPtr, this, data,
                                                array_length, is_end);
  }

  public int RunVad(short[] data, int array_length) {
    return snowboyJNI.SnowboyVad_RunVad__SWIG_5(swigCPtr, this, data,
                                                array_length);
  }

  public int RunVad(int[] data, int array_length, boolean is_end) {
    return snowboyJNI.SnowboyVad_RunVad__SWIG_6(swigCPtr, this, data,
                                                array_length, is_end);
  }

  public int RunVad(int[] data, int array_length) {
    return snowboyJNI.SnowboyVad_RunVad__SWIG_7(swigCPtr, this, data,
                                                array_length);
  }
